...
<div class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item active"><a href="{{ route('kelola_pengguna') }}">Data Pengguna</a></div>
          <div class="breadcrumb-item"><a href="{{ url('/edit_pengguna/'). $id }}">Edit Pengguna</a></div>
        </div>  
    </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <div class="custom-file">
                                      ...
                                      <label class="custom-file-label" for="customFile">C:\xampp\htdocs\laundrytugasakhir\public\pictures\{{ $penggunas->avatar }}</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
