	...
	<div class="header">
		<table style="width: 100%;" class="table-header">
			<tr>
				...
				<td class="text-right" style="padding-top: 50px; padding-left: 300px; padding-right: 50px;">{{ $transaksis->nama_outlet }}</td>
			</tr>
			<tr>
				<td colspan="2" style="text-align: right; padding-right: 50px; padding-top: -5px; color: #7571f9;">{{ $transaksis->hotline }}</td>
			</tr>
			<tr>
