...
<div class="section">
	<div class="section-header">
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item"><a href="{{ url('/laporan_pegawai') }}">Laporan Pegawai</a></div>
		  <div class="breadcrumb-item active"><a href="{{ url('/laporan_pegawai_riwayat/' . $id) }}">Riwayat Kerja Pegawai</a></div>
		</div>  
    </div>
	<div class="row">
		<div class="col-lg-3">
		                            ...
		                            <tbody class="isi_tabel">
		                            	...
		                            	<tr>
		                            		...
		                            		<td>
			                                    ...
			                                    <span class="badge badge-info text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'proses')
			                                    <span class="badge badge-warning text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'selesai')
			                                    <span class="badge badge-success text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'diantar')
			                                    <span class="badge badge-danger text-white">{{ $riwayat->status }}</span>
			                                    @elseif($riwayat->status == 'diambil')
			                                    <span class="badge badge-primary text-white">{{ $riwayat->status }}</span>
			                                    @endif
			                                </td>
		                            	</tr>
		                            	@endforeach
