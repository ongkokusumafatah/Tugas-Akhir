...
<div class="section">
	<div class="section-header">
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item"><a href="#">Layanan Laundry</a></div>
		  <div class="breadcrumb-item"><a href="{{ url('/kelola_pelanggan') }}">Data Pelanggan</a></div>
		  <div class="breadcrumb-item active"><a href="{{ url('/detail_pelanggan_member/' . $id) }}">Detail Pelanggan</a></div>
        </div>  
    </div>
                    	...
                    	<div class="col-md-12">
                    		<table style="width: 100%; margin-left: -10px;" class="tabel-identitas">
                    			...
                    			<tr>
                    				...
                    				<td style="padding: 5px;" class="align-top">:</td>
                    				<td style="padding: 5px;" class="align-top"><a href="https://wa.me/{{ $pelanggans->no_hp_pelanggan }}?text=Kami%20Dari%20Laundry Campus%20">{{ $pelanggans->no_hp_pelanggan }}</a></td>
                    			</tr>
                    			<tr>
							  ...
							  <tbody class="body-table-kilo">
							    ...
							    <tr class="table-light">
							      ...
							      <td>
                                    ...
                                    <span class="badge badge-info text-white">{{ $transaksi->status }}</span>
                                    @elseif($transaksi->status == 'proses')
                                    <span class="badge badge-warning text-white">{{ $transaksi->status }}</span>
                                    @elseif($transaksi->status == 'selesai')
                                    <span class="badge badge-success text-white">{{ $transaksi->status }}</span>
                                    @elseif($transaksi->status == 'diantar')
                                    <span class="badge badge-danger text-white">{{ $transaksi->status }}</span>
                                    @elseif($transaksi->status == 'diambil')
                                    <span class="badge badge-primary text-white">{{ $transaksi->status }}</span>
                                    @endif
							      </td>
