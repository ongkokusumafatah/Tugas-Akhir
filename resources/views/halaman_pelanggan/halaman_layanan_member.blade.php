...
<div class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="{{ url('/kelola_pelanggan') }}">Kelola Pelanggan</a></div>
          <div class="breadcrumb-item"><a href="{{ url('/layanan_member/' . $id) }}">Layanan Member</a></div>
        </div>  
    </div>
	<div class="row">
