...
<div class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          <div class="breadcrumb-item active"><a href="#">Layanan Jasa</a></div>
          <div class="breadcrumb-item">Registrasi Pelanggan</div>
        </div>  
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-pills mb-3" style="border-bottom: 1px solid #7571f9;">
                        ...
                        <li class="nav-item"><a href="#" class="layanan-tab nav-link">Layanan Jasa</a>
                        </li>
