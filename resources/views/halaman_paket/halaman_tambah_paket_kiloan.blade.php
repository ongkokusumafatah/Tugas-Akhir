...
<div class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
          ...
          <div class="breadcrumb-item active"><a href="{{ route('kelola_paket') }}">Data Paket</a></div>
          <div class="breadcrumb-item active">Tambah Paket Kiloan</div>
        </div>  
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ route('simpan_paket_kiloan') }}" method="post" name="paket_kiloan_baru_form">
                            @csrf
